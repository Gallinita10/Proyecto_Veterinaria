...
public class Productos_alimenticios extends Productos {
    ...
    public Productos_alimenticios(String peso_alimento, String fecha_caducidad, float precio_por_kilo, float precio_por_bolsa, float precio_proveedor, int id_productos, String nombre_producto, float precio_producto, String tipo_producto) {
    ...
    public Productos_alimenticios(String peso_alimento, String fecha_caducidad, float precio_por_kilo, float precio_por_bolsa, float precio_proveedor, String nombre_producto, float precio_producto, String tipo_producto) {
