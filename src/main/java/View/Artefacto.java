 ...
 * @author Enzo
 */
public class Artefacto extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Artefacto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
