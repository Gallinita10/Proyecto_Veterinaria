...
public class Proveedor {
    ...
    public Proveedor(int id_proveedor, String nombre, String direccion, String telefono, Tipo_proveedor id_tipo_proveedor) {
        this.id_proveedor = id_proveedor;
        this.nombre = nombre;
        this.direccion = direccion;
        this.telefono = telefono;
    ...
    public Proveedor(String nombre, String direccion, String telefono, Tipo_proveedor id_tipo_proveedor) {
        this.nombre = nombre;
        this.direccion = direccion;
        this.telefono = telefono;
        this.id_tipo_proveedor = id_tipo_proveedor;
